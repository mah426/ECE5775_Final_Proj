...
set C_modelArgList {
	...
	{ out_V int 32 regular {array 10000 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 99,"step" : 1},{"low" : 0,"up" : 99,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "out_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "out.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 99,"step" : 1},{"low" : 0,"up" : 99,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ out_V_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"], "CDFG" : "matmult", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		...
		{"Name" : "out_V", "Type" : "Memory", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : []}],
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.matmult_mul_32s_32s_32_6_U1", "Parent" : "0", "Child" : []}]}

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9020201", "Max" : "9020201"}
	, {"Name" : "Interval", "Min" : "9020202", "Max" : "9020202"}
]}
...
set Spec2ImplPortList { 
	...
	out_V { ap_memory {  { out_V_address0 mem_address 1 14 }  { out_V_ce0 mem_ce 1 1 }  { out_V_we0 mem_we 1 1 }  { out_V_d0 mem_din 1 32 }  { out_V_q0 mem_dout 0 32 } } }
}
