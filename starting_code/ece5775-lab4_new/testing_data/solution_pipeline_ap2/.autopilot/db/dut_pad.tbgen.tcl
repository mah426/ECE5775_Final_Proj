...
set C_modelArgList {
	...
	{ input_1 int 1 regular {array 2592 { 1 3 } 1 1 }  }
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"], "CDFG" : "dut_pad", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		...
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.dut_urem_13ns_13ns_13_17_seq_U1", "Parent" : "0", "Child" : []}]}
...
set Spec2ImplPortList { 
	...
	input_1 { ap_memory {  { input_1_address0 mem_address 1 12 }  { input_1_ce0 mem_ce 1 1 }  { input_1_q0 mem_dout 0 1 } } }
