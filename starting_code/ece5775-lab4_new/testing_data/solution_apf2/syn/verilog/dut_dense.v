...
reg    ap_sig_114;
wire   [9:0] n_cast7_fu_191_p1;
reg   [9:0] n_cast7_reg_383;
...
wire   [0:0] tmp_18_fu_276_p2;
reg   [0:0] tmp_18_reg_414;
reg    ap_sig_cseq_ST_st4_fsm_3;
reg    ap_sig_152;
reg    ap_sig_cseq_ST_st5_fsm_4;
reg    ap_sig_161;
wire   [31:0] grp_fu_172_p1;
reg   [31:0] tmp_20_reg_424;
...
reg   [8:0] m_reg_148;
wire   [63:0] newIndex3_fu_260_p1;
wire   [63:0] tmp_17_fu_265_p1;
wire   [0:0] tmp_13_fu_369_p2;
...
wire   [7:0] tmp_23_fu_219_p1;
wire   [10:0] p_shl_fu_223_p3;
wire   [8:0] tmp_24_fu_235_p2;
...
wire   [22:0] tmp_21_fu_305_p1;
wire   [0:0] notrhs_fu_333_p2;
wire   [0:0] notlhs_fu_327_p2;
wire   [7:0] tmp_7_fu_313_p4;
wire   [22:0] tmp_22_fu_323_p1;
wire   [0:0] notrhs9_fu_351_p2;
wire   [0:0] notlhs8_fu_345_p2;
wire   [0:0] tmp_9_fu_339_p2;
wire   [0:0] tmp_10_fu_357_p2;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (1'b0 == exitcond1_fu_195_p2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_st2_fsm_1)) begin
        ...
        n_cast7_reg_383[3 : 0] <= n_cast7_fu_191_p1[3 : 0];
    end
end
...
always @ (*) begin
    if ((((1'b0 == ap_start) & (1'b1 == ap_sig_cseq_ST_st1_fsm_0)) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond1_fu_195_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond1_fu_195_p2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if (~(1'b0 == exitcond1_fu_195_p2)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
...
assign biased_max_fu_375_p3 = ((tmp_13_fu_369_p2[0:0] === 1'b1) ? reg_185 : max_reg_112);

assign biased_to_int_fu_291_p1 = reg_185;

assign exitcond1_fu_195_p2 = ((n_reg_124 == ap_const_lv4_A) ? 1'b1 : 1'b0);

assign exitcond_fu_207_p2 = ((m_reg_148 == ap_const_lv9_100) ? 1'b1 : 1'b0);

assign grp_fu_172_p0 = tmp_18_reg_414;

assign input_0_address0 = newIndex3_fu_260_p1;
...
assign n_cast7_fu_191_p1 = n_reg_124;

assign newIndex3_fu_260_p1 = m_reg_148;

assign notlhs8_fu_345_p2 = ((tmp_7_fu_313_p4 != ap_const_lv8_FF) ? 1'b1 : 1'b0);

assign notlhs_fu_327_p2 = ((tmp_fu_295_p4 != ap_const_lv8_FF) ? 1'b1 : 1'b0);

assign notrhs9_fu_351_p2 = ((tmp_22_fu_323_p1 == ap_const_lv23_0) ? 1'b1 : 1'b0);

assign notrhs_fu_333_p2 = ((tmp_21_fu_305_p1 == ap_const_lv23_0) ? 1'b1 : 1'b0);

assign output_0_address0 = tmp_16_reg_434;

assign output_0_d0 = tmp_13_fu_369_p2;

assign p_shl1_cast_fu_241_p1 = tmp_24_fu_235_p2;

assign p_shl_cast_fu_231_p1 = p_shl_fu_223_p3;

assign p_shl_fu_223_p3 = {{tmp_23_fu_219_p1}, {ap_const_lv3_0}};

assign tmp1_cast_fu_250_p1 = tmp1_fu_245_p2;

assign tmp1_fu_245_p2 = (n_cast7_reg_383 + p_shl1_cast_fu_241_p1);

assign tmp2_fu_270_p2 = (w_fc2_q0 ^ 1'b1);

assign tmp_10_fu_357_p2 = (notrhs9_fu_351_p2 | notlhs8_fu_345_p2);

assign tmp_11_fu_363_p2 = (tmp_9_fu_339_p2 & tmp_10_fu_357_p2);

assign tmp_13_fu_369_p2 = (tmp_11_fu_363_p2 & tmp_12_reg_449);

assign tmp_16_fu_286_p1 = n_reg_124;

assign tmp_17_fu_265_p1 = w_index_fu_254_p2;

assign tmp_18_fu_276_p2 = (input_0_q0 ^ tmp2_fu_270_p2);

assign tmp_21_fu_305_p1 = biased_to_int_fu_291_p1[22:0];

assign tmp_22_fu_323_p1 = max_to_int_fu_309_p1[22:0];

assign tmp_23_fu_219_p1 = m_reg_148[7:0];

assign tmp_24_fu_235_p2 = m_reg_148 << ap_const_lv9_1;

assign tmp_7_fu_313_p4 = {{max_to_int_fu_309_p1[ap_const_lv32_1E : ap_const_lv32_17]}};

assign tmp_9_fu_339_p2 = (notrhs_fu_333_p2 | notlhs_fu_327_p2);

assign tmp_fu_295_p4 = {{biased_to_int_fu_291_p1[ap_const_lv32_1E : ap_const_lv32_17]}};

assign w_fc2_address0 = tmp_17_fu_265_p1;

assign w_index_fu_254_p2 = (p_shl_cast_fu_231_p1 + tmp1_cast_fu_250_p1);

always @ (posedge ap_clk) begin
    n_cast7_reg_383[9:4] <= 6'b000000;
