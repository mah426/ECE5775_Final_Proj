...
set id 1
set name dut_urem_12ns_11ns_12_16_seq
...
set id 2
set name dut_urem_13ns_11ns_13_17_seq
set corename simcore_urem_seq
set op urem
set stage_num 17
set max_latency -1
...
set id 3
set name dut_mux_8to1_sel32_1_1
...
set id 4
set name dut_mul_mul_13ns_15ns_28_1
...
set out_width 28
set exp i0*i1
set arg_lists {i0 {13 0 +} i1 {15 0 +} p {28 0 +} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 5
set name dut_mul_mul_12ns_14ns_26_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set out_width 26
set exp i0*i1
set arg_lists {i0 {12 0 +} i1 {14 0 +} p {26 0 +} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
    id ${id} \
